...
## 4. AGENT & SUBAGENT USAGE — UNLIMITED, ENCOURAGED, MANDATORY WHEN BENEFICIAL
...
## 5. ASK PROTOCOL — NO GUESSING, MAXIMUM CLARITY
...
## 8. SECURITY — ZERO-TRUST, CREDENTIAL SILENCE

These rules override every other rule. No exceptions.

### 8.1 Credential Silence — Hard Rule
...
### 8.4 Ask Before Credential Handling
...
## 10. HIGH-PRIORITY PARADIGM GUIDELINES
